...
&lt;!&ndash;        <div class="features" v-if="hasFeatures && !isMQMobile">
          <div
            class="feature"
      ...
      &lt;!&ndash; 移动端features块 e &ndash;&gt;
        ...
        <MainLayout style="padding-top: 50px">
            <template #mainLeft>
                <!-- 简约版文章列表 -->
                <UpdateArticle
                    class="card-box"
    ...
    computed: {
        ...
        showBanner() {
            ...
            return this.$route.query.p &&
                ...
                (!this.homeData.postList ||
                    this.homeData.postList === 'detailed')
                ? false
                : true
        },
        bannerBgStyle() {
